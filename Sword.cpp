...
Sword::Sword(bool isTwoHanded) :
	...
	m_mainSkill->addEffect(Effect::EffectCategory::PRIMARY, new Effect(Effect::EffectType::DEBUFF, Effect::EffectTarget::MOVEMENT, Effect::SkillType::DEXTERITY, 1, 3, true));
	m_mainSkill->addEffect(Effect::EffectCategory::SECONDARY, new Effect(Effect::EffectType::BUFF, Effect::EffectTarget::MOVEMENT, Effect::SkillType::DEXTERITY, 1, 3, true));
	// TWO HAND SWORD
	if (m_isTwoHanded) {
